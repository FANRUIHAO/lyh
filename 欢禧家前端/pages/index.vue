<template>
	<view class="start-index">
		...
		<tn-tabbar v-model="currentIndex" :list="tabbarList" activeColor="#cdec67" inactiveColor="#AAAAAA"
			activeIconColor="#cdec67" :animation="true" :safeAreaInsetBottom="true" @change="switchTabbar"></tn-tabbar>
